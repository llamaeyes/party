...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post rsvps_url, params: { rsvp: { attending: @rsvp.attending, comments: @rsvp.comments, name: @rsvp.name } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { attending: @rsvp.attending, comments: @rsvp.comments, name: @rsvp.name } }
